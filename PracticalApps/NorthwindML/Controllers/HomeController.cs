    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult GenerateDatasets()
        {
            foreach (string country in countries)
            {
                ...
                IEnumerable<ProductCobought> coboughtProducts = ordersInCountry.SelectMany(order => from lineItem1 in order.OrderDetails
                ...
                IDataView dataView = mlContext.Data.LoadFromTextFile(
                    ...
                    columns: new[]
                    {
                        ...
                        new TextLoader.Column( name:
                            ...
                            dataKind: DataKind.UInt32, source: new [] { new TextLoader.Range(0) }, keyCount: new KeyCount(77)),

                       new TextLoader.Column( name:
                            nameof(
                            ProductCobought.CoboughtProductID), dataKind: DataKind.UInt32, source: new [] { new TextLoader.Range(1) }, keyCount: new KeyCount(77))
                    },
                    hasHeader: true,
                    separatorChar: '\t'
                );
