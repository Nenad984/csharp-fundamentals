...
namespace WorkingWithFileSystems
{
    class Program
    {
        ...
        {
            var newFolder = Combine(GetFolderPath(SpecialFolder.Personal), "csharp-fundamentals", "Chapter09", "NewFolder");
        ...
        public static void WorkWithFiles()
        {
            ...
            var dir = Combine(GetFolderPath(SpecialFolder.Personal), "csharp-fundamentals", "Chapter09", "OutputFiles");
