    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            var people = new List<Person>
            {
                ...
                LastName = "Jones", DateOfBirth = new DateTime(1969, 11, 23)},

                new Person(20000M) { FirstName = "Charlie", LastName = "Cox",
                    DateOfBirth = new DateTime(1984, 5, 4),
                    Children = new HashSet<Person> { new Person(0M) { FirstName = "Sally", LastName = "Cox",
            ...
            {
                var loadedPeople = (List<Person>)await NuJson.DeserializeAsync(utf8Json: jsonLoad,
